...
name: growth-skills
description: >
  Index of all installed SaaS growth marketing skills. Shows categorized
  skill list with one-line descriptions, input requirements, and example
  commands. Use when the user says "what skills are available", "help",
  "what can you do", "growth skills", "list skills", "/growth-skills",
  or asks what they can do with this toolkit.
---

# Growth Skills Index

When this skill is triggered, display the following index exactly as shown.
Do not add commentary before or after. Do not modify the formatting.
...
GIVE ME YOUR METRICS — I'LL BENCHMARK:
  ...
  /retention-playbook diagnose       Churn risk scoring + interventions

GIVE ME A KEYWORD OR BRAND:
...
First time? Start with: /geo-seo-auditor audit <your-url>
```
