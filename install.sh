...
echo ""
echo -e "  ${CYAN}URL Audits${NC} (give a URL, get a score):"
echo -e "    /geo-seo-auditor audit <url>"
echo -e "    /landing-page-cro audit <url>"
echo -e "    /competitor-intel analyze <url>"
echo -e "    /web-app-growth-engine audit <url>"
echo -e "    /saas-landing-builder review <url>"
echo ""
echo -e "  ${CYAN}Metric Analysis${NC} (give your numbers, get benchmarks):"
echo -e "    /subscription-metrics calculate"
echo -e "    /plg-funnel-analyzer audit"
echo -e "    /pricing-analyzer audit"
echo -e "    /retention-playbook diagnose"
echo ""
echo -e "  ${CYAN}Search & Monitor${NC} (give a keyword or brand):"
echo -e "    /aso-optimizer analyze <app>"
echo -e "    /reddit-opportunity-finder search <keywords>"
echo -e "    /brand-mention-scanner scan <brand>"
echo -e "    /local-seo-optimizer audit <business>"
echo ""
echo -e "  ${CYAN}Text Analysis${NC} (give text, get insights):"
...
echo ""
echo -e "  Fastest first win (60 seconds, just needs a URL):"
echo -e "  ${YELLOW}/geo-seo-auditor audit https://yoursite.com${NC}"
echo ""
echo -e "  See all skills interactively:"
echo -e "  ${YELLOW}/growth-skills${NC}"
echo ""
echo "---------------------------------------------------"
echo ""
